...
public class Index : PageModel
{
    ...
    private readonly IOptions<SolenLmsWebClientUrl> _webClientUrl;
    ...
    public Index(
        ...
        IOptions<SolenLmsWebClientUrl> webClientUrl)
    {
        _accountService = accountService;
        _webClientUrl = webClientUrl;
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        {
            var (isSuccess, user) = await _accountService.UserPasswordSignInAsync(Input.Email, Input.Password, Input.RememberLogin);
            if (isSuccess)
            {
                ...
                {
                    return Redirect($"{_webClientUrl.Value.Value}/bff/login?");
                }
                else
                {
