...
namespace Imanys.SolenLms.IdentityProvider.Web.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    private async Task<User> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        ...
        var organisation = new Organization(Guid.NewGuid().ToString(), string.Empty, DateTime.Now);
        var user = new User(organisation, null, null)
        {
            Id = sub,
