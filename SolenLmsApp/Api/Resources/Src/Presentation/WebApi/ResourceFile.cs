...
namespace Imanys.SolenLms.Application.Resources.WebApi;
...
public sealed class ResourceFile : IResourceFile
{
    ...
    public ResourceFile(IFormFile formFile)
    {
        ...
        FileExtension = Path.GetExtension(ContentDispositionHeaderValue.Parse(formFile.ContentDisposition).FileName!.Trim('"'));
    }
